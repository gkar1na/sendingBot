...
def get_parser_commands_keyboard() -> vk_api.keyboard.VkKeyboard:
    ...
    keyboard.add_callback_button(
        ...
        color=VkKeyboardColor.PRIMARY,
        payload=['get_bd_to_sheets_commands_keyboard',
    ...
    keyboard.add_callback_button(
        ...
        color=VkKeyboardColor.NEGATIVE,
        payload=['get_command_menu_keyboard',
                 'Для возвращения разделам с командами нажмите кнопку "Назад"']
    )

    return keyboard


def get_bd_to_sheets_commands_keyboard() -> vk_api.keyboard.VkKeyboard:
