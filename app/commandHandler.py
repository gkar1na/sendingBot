...
class Handler:
    ...
    def add_text_attachments(self, event: Optional[Event] = None, args: Optional[List[str]] = None) -> int:
        return add.text_attachments(self.vk, self.session, event, args)

    def delete_text_attachments(self, event: Optional[Event] = None, args: Optional[List[str]] = None) -> int:
        return delete.text_attachments(self.vk, self.session, event, args)

    def clear_text_attachments(self, event: Optional[Event] = None, args: Optional[List[str]] = None) -> int:
